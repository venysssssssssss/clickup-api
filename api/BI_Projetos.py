...
custom_fields = [
    ...
    'Escopo',
    '💡 RESTRIÇÕES',
    'Tem impacto de privacidade (LGPD)',
    '.: ADMINISTRATIVO :.',
    '.: COMUNICAÇÃO :.',
    ...
    '.: QUALIDADE :.',
    '.: RH DAP :.',
    '.: RH RECRUTAMENTO E SELE.: TI FAST TRACKING (SISTEMAS) :.',
    '.: TI GOVERNANÇA :.',
    '.: TI MICROINFORMATICA :.',
    '.: TI OPERAÇÕES :.',
    '💡 ESTE PROJETO É REGULATÓRIO?',
    '💡 RISCO',
    'FOCAL',
...
for list_id in list_ids:
    ...
    while True:
        ...
        for task in data['tasks']:
            ...
            df_marks = pd.concat(
                [df_marks, pd.DataFrame([new_row])], ignore_index=True
            )
